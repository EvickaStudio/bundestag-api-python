...
from bundestag_api.types import Drucksache, DrucksacheListResponse
from bundestag_api._utils import parse_date, parse_datetime

base_url = os.environ.get("TEST_API_BASE_URL", "http://127.0.0.1:4010")


class TestDrucksache:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve(self, client: BundestagAPI) -> None:
        drucksache = client.drucksache.retrieve(
            id=1,
        )
        assert_matches_type(Drucksache, drucksache, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: BundestagAPI) -> None:
        response = client.drucksache.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        drucksache = response.parse()
        assert_matches_type(Drucksache, drucksache, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve(self, client: BundestagAPI) -> None:
        with client.drucksache.with_streaming_response.retrieve(
            id=1,
        ) as response:
    ...
    def test_method_list(self, client: BundestagAPI) -> None:
        drucksache = client.drucksache.list()
        assert_matches_type(DrucksacheListResponse, drucksache, path=["response"])
    ...
    def test_raw_response_list(self, client: BundestagAPI) -> None:
        response = client.drucksache.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BundestagAPI) -> None:
        with client.drucksache.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncDrucksache:
    ...
    async def test_method_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        drucksache = await async_client.drucksache.retrieve(
            id=1,
        )
        assert_matches_type(Drucksache, drucksache, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.drucksache.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        drucksache = await response.parse()
        assert_matches_type(Drucksache, drucksache, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.drucksache.with_streaming_response.retrieve(
            id=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncBundestagAPI) -> None:
        drucksache = await async_client.drucksache.list()
        assert_matches_type(DrucksacheListResponse, drucksache, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.drucksache.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.drucksache.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
