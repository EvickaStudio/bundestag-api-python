...
class TestPlenarprotokoll:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve(self, client: BundestagAPI) -> None:
        plenarprotokoll = client.plenarprotokoll.retrieve(
            id=1,
        )
        assert_matches_type(Plenarprotokoll, plenarprotokoll, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: BundestagAPI) -> None:
        response = client.plenarprotokoll.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        plenarprotokoll = response.parse()
        assert_matches_type(Plenarprotokoll, plenarprotokoll, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve(self, client: BundestagAPI) -> None:
        with client.plenarprotokoll.with_streaming_response.retrieve(
            id=1,
        ) as response:
    ...
    def test_method_list(self, client: BundestagAPI) -> None:
        plenarprotokoll = client.plenarprotokoll.list()
        assert_matches_type(PlenarprotokollListResponse, plenarprotokoll, path=["response"])
    ...
    def test_raw_response_list(self, client: BundestagAPI) -> None:
        response = client.plenarprotokoll.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BundestagAPI) -> None:
        with client.plenarprotokoll.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPlenarprotokoll:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        plenarprotokoll = await async_client.plenarprotokoll.retrieve(
            id=1,
        )
        assert_matches_type(Plenarprotokoll, plenarprotokoll, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.plenarprotokoll.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        plenarprotokoll = await response.parse()
        assert_matches_type(Plenarprotokoll, plenarprotokoll, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.plenarprotokoll.with_streaming_response.retrieve(
            id=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncBundestagAPI) -> None:
        plenarprotokoll = await async_client.plenarprotokoll.list()
        assert_matches_type(PlenarprotokollListResponse, plenarprotokoll, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.plenarprotokoll.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.plenarprotokoll.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
