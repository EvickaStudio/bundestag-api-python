...
class TestVorgangsposition:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve(self, client: BundestagAPI) -> None:
        vorgangsposition = client.vorgangsposition.retrieve(
            id=1,
        )
        assert_matches_type(Vorgangsposition, vorgangsposition, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: BundestagAPI) -> None:
        response = client.vorgangsposition.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        vorgangsposition = response.parse()
        assert_matches_type(Vorgangsposition, vorgangsposition, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve(self, client: BundestagAPI) -> None:
        with client.vorgangsposition.with_streaming_response.retrieve(
            id=1,
        ) as response:
    ...
    def test_method_list(self, client: BundestagAPI) -> None:
        vorgangsposition = client.vorgangsposition.list()
        assert_matches_type(VorgangspositionListResponse, vorgangsposition, path=["response"])
    ...
    def test_raw_response_list(self, client: BundestagAPI) -> None:
        response = client.vorgangsposition.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BundestagAPI) -> None:
        with client.vorgangsposition.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncVorgangsposition:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        vorgangsposition = await async_client.vorgangsposition.retrieve(
            id=1,
        )
        assert_matches_type(Vorgangsposition, vorgangsposition, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.vorgangsposition.with_raw_response.retrieve(
            id=1,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        vorgangsposition = await response.parse()
        assert_matches_type(Vorgangsposition, vorgangsposition, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.vorgangsposition.with_streaming_response.retrieve(
            id=1,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncBundestagAPI) -> None:
        vorgangsposition = await async_client.vorgangsposition.list()
        assert_matches_type(VorgangspositionListResponse, vorgangsposition, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.vorgangsposition.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.vorgangsposition.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
