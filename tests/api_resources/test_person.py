...
from bundestag_api.types import Person, PersonListResponse
...
class TestPerson:
    ...
    def test_method_retrieve(self, client: BundestagAPI) -> None:
        ...
        assert_matches_type(Person, person, path=["response"])
    ...
    def test_raw_response_list(self, client: BundestagAPI) -> None:
        response = client.person.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BundestagAPI) -> None:
        with client.person.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPerson:
    ...
    async def test_method_list(self, async_client: AsyncBundestagAPI) -> None:
        person = await async_client.person.list()
        assert_matches_type(PersonListResponse, person, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBundestagAPI) -> None:
        response = await async_client.person.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBundestagAPI) -> None:
        async with async_client.person.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
